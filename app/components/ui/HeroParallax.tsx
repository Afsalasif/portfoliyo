  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-white">
       these are the some of the projects that i have been working on
      </p>
    </div>
  );
};
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 uppercase left-4 opacity-0 group-hover/product:opacity-100 text-white">
        {product.title}
      </h2>
